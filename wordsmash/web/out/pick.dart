...
void init_autogenerated() {
  ...
  var __e11, __e15, __e16, __e17, __e18, __e19, __e20, __e21, __e3, __e7;
  ...
  __t.listen(__e16.onClick, ($event) { pickSentence(); });
  __e17 = __root.nodes[1].nodes[1].nodes[13];
  __t.listen(__e17.onClick, ($event) { refreshWordLists(); });
  __e18 = __root.nodes[1].nodes[5];
  __t.listen(__e18.onChange, ($event) { adj = __e18.value; });
  __t.listen(__e18.onChange, ($event) { wordChanged($event); });
  __t.oneWayBind(() => adj, (e) { if (__e18.value != e) __e18.value = e; }, false, false);
  __e19 = __root.nodes[1].nodes[12];
  __t.listen(__e19.onChange, ($event) { noun = __e19.value; });
  __t.listen(__e19.onChange, ($event) { wordChanged($event); });
  __t.oneWayBind(() => noun, (e) { if (__e19.value != e) __e19.value = e; }, false, false);
  __e20 = __root.nodes[1].nodes[19];
  __t.listen(__e20.onChange, ($event) { verb = __e20.value; });
  __t.listen(__e20.onChange, ($event) { wordChanged($event); });
  __t.oneWayBind(() => verb, (e) { if (__e20.value != e) __e20.value = e; }, false, false);
  __e21 = __root.nodes[1].nodes[26];
  __t.listen(__e21.onClick, ($event) { getGoogleImage(); });
  __t.create();
  __t.insert();
}
