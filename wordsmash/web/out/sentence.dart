// Auto-generated from sentence.html.
// DO NOT EDIT.

library sentence_html;
...
void init_autogenerated() {
  ...
  __e9 = __root.nodes[1].nodes[3].nodes[7];
  __t.listen(__e9.onClick, ($event) { newPage(); });
  __e10 = __root.nodes[1].nodes[3].nodes[13];
  __t.listen(__e10.onClick, ($event) { getGoogleImage(); });
  __e11 = __root.nodes[1].nodes[3].nodes[19];
  __t.listen(__e11.onClick, ($event) { generateFullStory(); });
  __e12 = __root.nodes[3];
  __t.listen(__e12.onClick, ($event) { generateFullStory(); });
  __t.create();
  __t.insert();
}

//@ sourceMappingURL=sentence.dart.map